			...
			<div id="hero">
				<div id="hero-titles">
					<div class="hero-titles-center white">
						<h2 class="h2-title left"><em class="outline small"><em class="mobilehide"><a class="outline-link" href="../store">Store </a>&nbsp; / &nbsp; </em></em>Smart Lock<em class="outline">.</em></h2>
					</div>
				</div>
			</div> <!-- /hero -->
					...
					<div class="grid">
						...
						<div id="store-grid-right" class="grid-3-col-product col3-right">
							<div class="grid-3-col-text">
								<p class="p-text gray left">De Lock legt de basis van jouw veilige Space. De Lock is een slim deurslot wat in
									contact staat met de SafeSpace app op je telefoon. Door gebruik van de app is het
									mogelijk om je deurslot altijd en overal te openen en te sluiten. De telefoon is een van
									de belangrijkste benodigdheden in het dagelijks leven, en de kans dat je jouw telefoon
									vergeet is veel kleiner dan de kans dat je je sleutel vergeet. Met de Lock is dit probleem
									verholpen.
									<br><br>
									De Lock is een echte aanrader voor een fan van de smart home. De fijne bediening en
									gemakkelijke installatie zorgen ervoor dat de Lock voor groot en klein en jong en oud
									bruikbaar is.
								</p>
							</div>
						</div>
						...
						<div id="store-grid-right" class="grid-3-col-product col3-right">
							<div class="grid-3-col-text">
								<p class="p-text gray left">
									...
									&bull; &nbsp; Controle over je voordeur
								</p>
							</div>
						</div>
